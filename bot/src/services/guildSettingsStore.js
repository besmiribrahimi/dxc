...
function sanitizeGuildSettings(raw, defaults) {
  ...
  return {
    ...
    welcomeChannelId: String(input.welcomeChannelId || defaults.welcomeChannelId || "").trim(),
    welcomeMessage: String(input.welcomeMessage || defaults.welcomeMessage || "").trim().slice(0, 1024),
    autoRoleId: String(input.autoRoleId || defaults.autoRoleId || "").trim(),
